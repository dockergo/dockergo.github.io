...
TAB_META = {
    ...
    "panowalk":("◇", "架构地图 · 双维模型 / 总架构图 / 物理部署 / 依赖矩阵 / 依赖关系 / 部署形态", "参考"),
...
THEMES = [
    ...
    {"id": "overallarch", "icon": "◇", "title": "架构与部署", "cat": "appendix", "ord": 1,
     "desc": "架构地图 + 部署形态合一:双维模型(能力域×执行时机)· 总架构图(位置即语义)· 物理部署视图(Shard/Replica/Keeper)· 依赖矩阵(接口主线×能力域)· 能力域依赖关系 · 部署形态物理布局对比",
     "tabs": ["panowalk"]},
]
