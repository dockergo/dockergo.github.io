...
ARCH_HOTSPOTS = [
    # 顶部 powers 标题条 → 全景总览
    (30, 46, 960, 40, "ZooKeeper原理_全景主线框架"),
    # ① 客户端接触面
    (30, 98, 960, 30, "ZooKeeper原理_接口_客户端API与znode"),   # 标题带
    (48, 130, 300, 24, "ZooKeeper原理_接口_客户端API与znode"),  # 写
    (360, 130, 300, 24, "ZooKeeper原理_接口_客户端API与znode"), # 读
    (672, 130, 300, 24, "ZooKeeper原理_接口_客户端API与znode"), # watch/session
    # ② 请求处理链
    (30, 172, 960, 30, "ZooKeeper原理_支撑_请求处理链"),        # 标题带
    (30, 200, 960, 46, "ZooKeeper原理_支撑_请求处理链"),        # 流水线盒
    # ③ ZAB（左）
    (30, 258, 478, 40, "ZooKeeper原理_支撑_ZAB原子广播"),        # 标题
    (48, 288, 220, 34, "ZooKeeper原理_支撑_ZAB原子广播"),        # 选举
    (278, 288, 212, 34, "ZooKeeper原理_支撑_ZAB原子广播"),       # 广播
    (30, 328, 478, 34, "ZooKeeper原理_支撑_ZAB原子广播"),        # Leader/Follower/zxid
    # ④ DataTree（右）
    (512, 258, 478, 40, "ZooKeeper原理_支撑_数据树DataTree"),    # 标题
    (530, 288, 212, 34, "ZooKeeper原理_支撑_数据树DataTree"),    # nodes
    (752, 288, 220, 34, "ZooKeeper原理_支撑_数据树DataTree"),    # ephemerals
    (512, 328, 478, 34, "ZooKeeper原理_支撑_数据树DataTree"),    # DataNode
    # ⑤ session / watch / acl
    (30, 380, 300, 74, "ZooKeeper原理_支撑_会话与临时节点"),
    (346, 380, 300, 74, "ZooKeeper原理_支撑_Watch机制"),
    (662, 380, 328, 74, "ZooKeeper原理_支撑_ACL权限"),
    # ⑥ 事务日志与快照 / 集群与 Quorum
    (30, 468, 620, 82, "ZooKeeper原理_支撑_事务日志与快照"),
    (666, 468, 324, 82, "ZooKeeper原理_支撑_集群与Quorum"),
]
...
(function(){
  ...
  var saved=localStorage.getItem('zookeeper-atlas-theme');
  ...
  function toggleTheme(){
    ...
    localStorage.setItem('zookeeper-atlas-theme',cur);
